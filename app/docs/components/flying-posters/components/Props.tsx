  ...
  const props = [
    {
      ...
      type: 'string[]',
      default: '[]',
      description: 'Array of image URLs for the flying posters.',
    },
    {
      name: 'planeWidth',
      type: 'number',
      default: '320',
      description: 'Width of each poster plane in pixels.',
    },
    {
      name: 'planeHeight',
      type: 'number',
      default: '320',
      description: 'Height of each poster plane in pixels.',
    },
    {
      name: 'distortion',
      type: 'number',
      default: '3',
      description: 'Amount of distortion effect applied to posters.',
    },
    {
      name: 'scrollEase',
      type: 'number',
      default: '0.01',
      description: 'Easing factor for scroll animations (lower = smoother).',
    },
    {
      name: 'cameraFov',
      type: 'number',
    ...
    },
    {
      ...
      type: 'number',
      default: '20',
      description: 'Camera distance from the scene on Z-axis.',
    },
    {
      name: 'className',
      type: 'string',
