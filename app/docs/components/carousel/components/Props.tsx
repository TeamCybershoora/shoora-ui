  ...
  const props = [
    {
      ...
      description: 'Array of carousel items with title, description, id, and icon.',
    },
    {
      name: 'baseWidth',
      type: 'number',
    ...
    },
    {
      ...
      type: 'number',
      default: '3000',
      description: 'Delay between automatic rotations in milliseconds.',
    },
    {
      name: 'pauseOnHover',
      type: 'boolean',
      default: 'false',
      description: 'Pause autoplay when hovering over carousel.',
    },
    {
      name: 'loop',
      type: 'boolean',
      default: 'true',
      description: 'Enable infinite looping through items.',
    },
  ];
