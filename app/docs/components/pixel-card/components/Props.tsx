  ...
  const props = [
    {
      ...
      default: '"default"',
      description: 'Predefined variant configuration for the pixel card.',
    },
    {
      name: 'gap',
      type: 'number',
      default: 'varies by variant',
      description: 'Size of the gap between pixels in pixels.',
    },
    {
      name: 'speed',
      type: 'number',
      default: 'varies by variant',
      description: 'Animation speed for pixel effects.',
    },
    {
      name: 'colors',
      type: 'string',
      default: 'varies by variant',
      description: 'Comma-separated list of colors for pixels.',
    },
    {
      name: 'noFocus',
      type: 'boolean',
      default: 'varies by variant',
      description: 'Disable focus effect on the card.',
    },
    {
      name: 'className',
      type: 'string',
    ...
    },
    {
      ...
      default: 'required',
      description: 'Content to display inside the pixel card.',
    },
  ];
