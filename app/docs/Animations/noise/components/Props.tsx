  ...
  const props = [
    {
      ...
      type: 'number',
      default: '250',
      description: 'The size of the noise pattern.',
    },
    {
      name: 'patternScaleX',
      type: 'number',
      default: '1',
      description: 'The horizontal scale of the noise pattern.',
    },
    {
      name: 'patternScaleY',
      type: 'number',
      default: '1',
      description: 'The vertical scale of the noise pattern.',
    },
    {
      name: 'patternRefreshInterval',
      type: 'number',
      default: '2',
      description: 'The interval in seconds for refreshing the noise pattern.',
    },
    {
      name: 'patternAlpha',
      type: 'number',
      default: '15',
      description: 'The alpha transparency of the noise pattern.',
    },
    {
      name: 'className',
      type: 'string',
