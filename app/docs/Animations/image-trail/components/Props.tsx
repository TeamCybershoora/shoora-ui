  ...
  const props = [
    {
      ...
      type: 'number',
      default: '0',
      description: 'Key to force re-render of the component.',
    },
    {
      name: 'items',
      type: 'string[]',
      default: '[]',
      description: 'Array of image URLs to display in the trail.',
    },
    {
      name: 'variant',
      type: 'number',
      default: '1',
      description: 'Animation variant to use (1, 2, or 3).',
    },
    {
      name: 'className',
      type: 'string',
