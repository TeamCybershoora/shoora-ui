  ...
  const props = [
    {
      ...
      type: 'string',
      default: 'white',
      description: 'The color of the crosshair lines.',
    },
    {
      name: 'containerRef',
      type: 'RefObject<HTMLElement | HTMLDivElement>',
      default: 'undefined',
      description: 'Optional container reference to scope the crosshair movement within a specific element.',
    },
  ];
