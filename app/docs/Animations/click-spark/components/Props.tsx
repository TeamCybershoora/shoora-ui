  ...
  const props = [
    {
      ...
      type: 'string',
      default: '#fff',
      description: 'The color of the spark particles.',
    },
    {
      name: 'sparkSize',
      type: 'number',
      default: '10',
      description: 'The size of each spark particle in pixels.',
    },
    {
      name: 'sparkRadius',
      type: 'number',
      default: '15',
      description: 'The radius within which spark particles appear.',
    },
    {
      name: 'sparkCount',
      type: 'number',
      default: '8',
      description: 'The number of spark particles to generate on click.',
    },
    {
      name: 'duration',
      type: 'number',
      default: '400',
      description: 'The duration of the spark animation in milliseconds.',
    },
    {
      name: 'children',
      type: 'React.ReactNode',
      default: '-',
      description: 'The content that will trigger spark effects on click.',
    },
    {
      name: 'className',
      type: 'string',
