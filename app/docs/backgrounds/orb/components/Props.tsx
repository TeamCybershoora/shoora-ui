  ...
  const props = [
    {
      ...
      type: 'number',
      default: '0',
      description: 'Hue value for the orb color (0-360 degrees)'
    },
    {
      name: 'hoverIntensity',
      type: 'number',
      default: '0.5',
      description: 'Intensity of the hover effect'
    },
    {
      name: 'rotateOnHover',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Force the hover state to be active'
    },
    {
      name: 'backgroundColor',
      type: 'string',
      default: "'#000000'",
      description: 'Background color of the orb container'
    }
  ];
