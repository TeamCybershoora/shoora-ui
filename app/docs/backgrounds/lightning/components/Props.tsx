  ...
  const props = [
    {
      ...
      type: "number",
      default: 220,
      description: "Color hue for lightning effect (0-360 degrees)"
    },
    {
      name: "xOffset",
      type: "number",
      default: 0,
      description: "Horizontal offset for lightning position (-2 to 2)"
    },
    {
      name: "speed",
      type: "number",
      default: 1,
      description: "Animation speed of lightning effect (0.1-3)"
    },
    {
      name: "intensity",
      type: "number",
      default: 1,
      description: "Intensity of lightning strikes (0.1-3)"
    },
    {
      name: "size",
      type: "number",
      default: 1,
      description: "Size of lightning bolts (0.1-3)"
    },
    {
      name: "className",
      type: "string",
      default: "custom-lightning",
    ...
    },
    {
      ...
      type: "string",
      default: "100%",
      description: "Width of lightning container"
    },
    {
      name: "height",
      type: "string",
      default: "600px",
      description: "Height of lightning container"
    },
    {
      name: "quality",
      type: "string",
